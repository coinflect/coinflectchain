...
import (
	...
	coreth "github.com/coinflect/coreth/plugin/evm"

	"github.com/coinflect/coinflectchain/api/admin"
	"github.com/coinflect/coinflectchain/api/auth"
	...
	"github.com/coinflect/coinflectchain/indexer"
	...
	"github.com/coinflect/coinflectchain/network/peer"
	...
	"github.com/coinflect/coinflectchain/utils/filesystem"
	...
	"github.com/coinflect/coinflectchain/utils/math/meter"
	...
	"github.com/coinflect/coinflectchain/vms/registry"
	"github.com/coinflect/coinflectchain/vms/secp256k1fx"

	ipcsapi "github.com/coinflect/coinflectchain/api/ipcs"
)
...
// Node is an instance of an Coinflect node.
type Node struct {
	Log        logging.Logger
...
func (n *Node) initChainManager(cfltAssetID ids.ID) error {
...
// initVMs initializes the VMs Coinflect supports + any additional vms installed as plugins.
func (n *Node) initVMs() error {
	...
	// Register the VMs that Coinflect supports
	errs := wrappers.Errs{}
	errs.Add(
...
func (n *Node) Initialize(
	...
	if err := n.initChainManager(n.Config.CfltAssetID); err != nil { // Set up the chain manager
