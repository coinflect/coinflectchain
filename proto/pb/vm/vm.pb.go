...
type InitializeRequest struct {
	...
	CfltAssetId  []byte               `protobuf:"bytes,6,opt,name=cflt_asset_id,json=cfltAssetId,proto3" json:"cflt_asset_id,omitempty"`
...
func (x *InitializeRequest) GetCfltAssetId() []byte {
	if x != nil {
		return x.CfltAssetId
	}
	return nil
}
