...
func (b *builder) NewBaseTx(
	...
	cflt.SortTransferableOutputs(outputs, Parser.Codec()) // sort the outputs

	return &txs.BaseTx{BaseTx: cflt.BaseTx{
...
func (b *builder) NewCreateAssetTx(
	...
	toBurn := map[ids.ID]uint64{
		b.backend.CFLTAssetID(): b.backend.CreateAssetTxFee(),
	}
	ops := common.NewOptions(options)
...
func (b *builder) NewImportTx(
	...
	cflt.SortTransferableOutputs(outputs, Parser.Codec())
	return &txs.ImportTx{
		BaseTx: txs.BaseTx{BaseTx: cflt.BaseTx{
			NetworkID:    b.backend.NetworkID(),
			BlockchainID: b.backend.BlockchainID(),
...
func (b *builder) spend(
	...
	cflt.SortTransferableOutputs(outputs, Parser.Codec()) // sort the change outputs
