...
import (
	...
	"github.com/coinflect/coinflectchain/utils/linkedhashmap"
	"github.com/coinflect/coinflectchain/utils/logging"
	"github.com/coinflect/coinflectchain/utils/metric"
...
func NewLatency(metricName, descriptionName string, log logging.Logger, namespace string, reg prometheus.Registerer) (Latency, error) {
	...
	l := &latency{
		...
		// e.g.,
		// "coinflect_7y7zwo7XatqnX4dtTakLo32o7jkMX4XuDa26WaxbCXoCT1qKK_blks_processing" to count how blocks are currently processing
		...
		// e.g.,
		// "coinflect_C_blks_accepted_count" to count how many "Observe" gets called -- count all "Accept"
		// "coinflect_C_blks_accepted_sum" to count how many ns have elapsed since its issuance on acceptance
		// "coinflect_C_blks_accepted_sum / coinflect_C_blks_accepted_count" is the average block acceptance latency in ns
		// "coinflect_C_blks_accepted_container_size_sum" to track cumulative sum of all accepted blocks' sizes
		// "coinflect_C_blks_accepted_container_size_sum / coinflect_C_blks_accepted_count" is the average block size
		...
		// e.g.,
		// "coinflect_P_blks_rejected_count" to count how many "Observe" gets called -- count all "Reject"
		// "coinflect_P_blks_rejected_sum" to count how many ns have elapsed since its issuance on rejection
		// "coinflect_P_blks_accepted_sum / coinflect_P_blks_accepted_count" is the average block acceptance latency in ns
		// "coinflect_P_blks_accepted_container_size_sum" to track cumulative sum of all accepted blocks' sizes
		// "coinflect_P_blks_accepted_container_size_sum / coinflect_P_blks_accepted_count" is the average block size
