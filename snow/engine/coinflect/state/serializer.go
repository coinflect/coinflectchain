...
// Package state manages the meta-data required by consensus for an coinflect
// dag.
package state
...
func (s *Serializer) ParseVtx(ctx context.Context, b []byte) (coinflect.Vertex, error) {
...
func (s *Serializer) GetVtx(_ context.Context, vtxID ids.ID) (coinflect.Vertex, error) {
