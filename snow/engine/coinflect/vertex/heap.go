...
type priorityQueue []coinflect.Vertex
...
func (vh *maxHeightVertexHeap) Push(vtx coinflect.Vertex) bool {
	vtxID := vtx.ID()
...
func (vh *maxHeightVertexHeap) Pop() coinflect.Vertex {
	vtx := heap.Pop(&vh.heap).(coinflect.Vertex)
