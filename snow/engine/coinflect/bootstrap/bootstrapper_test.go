...
import (
	...
	"github.com/coinflect/coinflectchain/snow/engine/coinflect/getter"
...
func TestBootstrapperSingleFrontier(t *testing.T) {
	...
	manager.ParseVtxF = func(_ context.Context, vtxBytes []byte) (coinflect.Vertex, error) {
		switch {
...
func TestBootstrapperTxDependencies(t *testing.T) {
	...
	vtx1 := &coinflect.TestVertex{
		...
		ParentsV: []coinflect.Vertex{vtx0}, // Depends on vtx0
		HeightV:  1,
...
func TestBootstrapperIncompleteAncestors(t *testing.T) {
	...
	vtx2 := &coinflect.TestVertex{
		...
		ParentsV: []coinflect.Vertex{vtx1},
		HeightV:  2,
		BytesV:   vtxBytes2,
	}
...
func TestRestartBootstrapping(t *testing.T) {
	...
	vtx3 := &coinflect.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     vtxID3,
			StatusV: choices.Unknown,
		},
		ParentsV: []coinflect.Vertex{vtx2},
		HeightV:  3,
		BytesV:   vtxBytes3,
	}
	vtx4 := &coinflect.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     vtxID4,
			StatusV: choices.Unknown,
		},
	...
	vtx5 := &coinflect.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     vtxID5,
			StatusV: choices.Unknown,
		},
		ParentsV: []coinflect.Vertex{vtx4},
		HeightV:  4,
		BytesV:   vtxBytes5,
	}
