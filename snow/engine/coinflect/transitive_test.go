...
func TestEngineAdd(t *testing.T) {
	...
	vtx := &coinflect.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
		ParentsV: []coinflect.Vertex{
			&coinflect.TestVertex{TestDecidable: choices.TestDecidable{
				IDV:     ids.GenerateTestID(),
	...
	manager.ParseVtxF = func(_ context.Context, b []byte) (coinflect.Vertex, error) {
	...
	manager.ParseVtxF = func(context.Context, []byte) (coinflect.Vertex, error) {
...
func TestEngineQuery(t *testing.T) {
	...
	gVtx := &coinflect.TestVertex{TestDecidable: choices.TestDecidable{
		IDV:     ids.GenerateTestID(),
		StatusV: choices.Accepted,
	}}
	mVtx := &coinflect.TestVertex{TestDecidable: choices.TestDecidable{
		IDV:     ids.GenerateTestID(),
		StatusV: choices.Accepted,
	}}

	vts := []coinflect.Vertex{gVtx, mVtx}
	...
	manager.GetVtxF = func(_ context.Context, id ids.ID) (coinflect.Vertex, error) {
		switch id {
		case gVtx.ID():
			return gVtx, nil
		case mVtx.ID():
	...
	vertexed := new(bool)
	manager.GetVtxF = func(_ context.Context, vtxID ids.ID) (coinflect.Vertex, error) {
		if *vertexed {
...
func TestEngineMultipleQuery(t *testing.T) {
	...
	engCfg.Params = coinflect.Parameters{
...
func TestEngineAbandonResponse(t *testing.T) {
	...
	manager.GetVtxF = func(context.Context, ids.ID) (coinflect.Vertex, error) {
		return nil, errUnknownVertex
	}
...
func TestEngineRejectDoubleSpendTx(t *testing.T) {
	...
	manager.BuildVtxF = func(_ context.Context, _ []ids.ID, txs []snowstorm.Tx) (coinflect.Vertex, error) {
		return &coinflect.TestVertex{
			TestDecidable: choices.TestDecidable{
				IDV:     ids.GenerateTestID(),
				StatusV: choices.Processing,
			},
			ParentsV: []coinflect.Vertex{gVtx, mVtx},
			HeightV:  1,
			TxsV:     txs,
			BytesV:   []byte{1},
		}, nil
...
func TestEngineReissue(t *testing.T) {
	...
	vm.CantSetState = true
	lastVtx := new(coinflect.TestVertex)
	manager.BuildVtxF = func(_ context.Context, _ []ids.ID, txs []snowstorm.Tx) (coinflect.Vertex, error) {
		lastVtx = &coinflect.TestVertex{
			TestDecidable: choices.TestDecidable{
				IDV:     ids.GenerateTestID(),
				StatusV: choices.Processing,
			},
...
func TestEngineParentBlockingInsert(t *testing.T) {
	...
	missingVtx := &coinflect.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Unknown,
		},
	...
	parentVtx := &coinflect.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
		ParentsV: []coinflect.Vertex{missingVtx},
		HeightV:  2,
		BytesV:   []byte{0, 1, 2, 3},
	}

	blockingVtx := &coinflect.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
		ParentsV: []coinflect.Vertex{parentVtx},
		HeightV:  3,
		BytesV:   []byte{0, 1, 2, 3},
	}
...
func TestEngineBlockingChitResponse(t *testing.T) {
	...
	issuedVtx := &coinflect.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
...
func TestEngineReissueAbortedVertex(t *testing.T) {
	...
	vtx1 := &coinflect.TestVertex{
		...
		ParentsV: []coinflect.Vertex{vtx0},
		HeightV:  2,
		BytesV:   vtxBytes1,
	}
...
func TestEngineDuplicatedIssuance(t *testing.T) {
	...
	manager.BuildVtxF = func(context.Context, []ids.ID, []snowstorm.Tx) (coinflect.Vertex, error) {
...
func TestEngineBubbleVotes(t *testing.T) {
	...
	missingVtx := &coinflect.TestVertex{TestDecidable: choices.TestDecidable{
		IDV:     ids.GenerateTestID(),
		StatusV: choices.Unknown,
	}}

	pendingVtx0 := &coinflect.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
		ParentsV: []coinflect.Vertex{vtx, missingVtx},
		HeightV:  1,
		TxsV:     []snowstorm.Tx{tx1},
		BytesV:   []byte{1},
	}

	pendingVtx1 := &coinflect.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
		ParentsV: []coinflect.Vertex{pendingVtx0},
		HeightV:  2,
		TxsV:     []snowstorm.Tx{tx2},
		BytesV:   []byte{2},
	}
...
func TestAbandonTx(t *testing.T) {
	...
	vtx0 := &coinflect.TestVertex{ // Contains tx0, which will fail verification
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Unknown,
		},
		ParentsV: []coinflect.Vertex{gVtx},
