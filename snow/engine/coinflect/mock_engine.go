...
// Source: github.com/coinflect/coinflectchain/snow/engine/coinflect (interfaces: Engine)

// Package coinflect is a generated GoMock package.
package coinflect
...
import (
	...
	snow "github.com/coinflect/coinflectchain/snow"
	coinflect "github.com/coinflect/coinflectchain/snow/consensus/coinflect"
	common "github.com/coinflect/coinflectchain/snow/engine/common"
	version "github.com/coinflect/coinflectchain/version"
...
func (m *MockEngine) GetVtx(arg0 context.Context, arg1 ids.ID) (coinflect.Vertex, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetVtx", arg0, arg1)
	ret0, _ := ret[0].(coinflect.Vertex)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
