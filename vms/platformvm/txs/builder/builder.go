...
func New(
	...
	fx fx.Fx,
	state state.Chain,
	atomicUTXOManager cflt.AtomicUTXOManager,
...
func (b *builder) NewImportTx(
	...
	importedCFLT := importedAmounts[b.ctx.CFLTAssetID]

	ins := []*cflt.TransferableInput{}
	outs := []*cflt.TransferableOutput{}
	switch {
	case importedCFLT < b.cfg.TxFee: // imported amount goes toward paying tx fee
		var baseSigners [][]*crypto.PrivateKeySECP256K1R
		ins, outs, _, baseSigners, err = b.Spend(keys, 0, b.cfg.TxFee-importedCFLT, changeAddr)
		if err != nil {
			return nil, fmt.Errorf("couldn't generate tx inputs/outputs: %w", err)
		}
		signers = append(baseSigners, signers...)
		delete(importedAmounts, b.ctx.CFLTAssetID)
	case importedCFLT == b.cfg.TxFee:
		delete(importedAmounts, b.ctx.CFLTAssetID)
	default:
		importedAmounts[b.ctx.CFLTAssetID] -= b.cfg.TxFee
	}
	...
	cflt.SortTransferableOutputs(outs, txs.Codec) // sort imported outputs
...
// TODO: should support other assets than CFLT
func (b *builder) NewExportTx(
	...
	utx := &txs.ExportTx{
		...
		ExportedOutputs: []*cflt.TransferableOutput{{ // Exported to X-Chain
			Asset: cflt.Asset{ID: b.ctx.CFLTAssetID},
			Out: &secp256k1fx.TransferOutput{
				Amt: amount,
				OutputOwners: secp256k1fx.OutputOwners{
					Locktime:  0,
