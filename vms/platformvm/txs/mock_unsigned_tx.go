...
// Source: github.com/coinflect/coinflectchain/vms/platformvm/txs (interfaces: UnsignedTx)
...
func (m *MockUnsignedTx) Outputs() []*cflt.TransferableOutput {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Outputs")
	ret0, _ := ret[0].([]*cflt.TransferableOutput)
	return ret0
}
