...
// Source: github.com/coinflect/coinflectchain/vms/platformvm/utxo (interfaces: Verifier)
...
import (
	...
	verify "github.com/coinflect/coinflectchain/vms/components/verify"
	state "github.com/coinflect/coinflectchain/vms/platformvm/state"
...
func (m *MockVerifier) VerifySpend(arg0 txs.UnsignedTx, arg1 state.UTXOGetter, arg2 []*cflt.TransferableInput, arg3 []*cflt.TransferableOutput, arg4 []verify.Verifiable, arg5 map[ids.ID]uint64) error {
	m.ctrl.T.Helper()
...
func (m *MockVerifier) VerifySpendUTXOs(arg0 txs.UnsignedTx, arg1 []*cflt.UTXO, arg2 []*cflt.TransferableInput, arg3 []*cflt.TransferableOutput, arg4 []verify.Verifiable, arg5 map[ids.ID]uint64) error {
	m.ctrl.T.Helper()
