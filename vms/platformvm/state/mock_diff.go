...
// Source: github.com/coinflect/coinflectchain/vms/platformvm/state (interfaces: Diff)
...
func (m *MockDiff) AddRewardUTXO(arg0 ids.ID, arg1 *cflt.UTXO) {
	m.ctrl.T.Helper()
...
func (m *MockDiff) AddUTXO(arg0 *cflt.UTXO) {
	m.ctrl.T.Helper()
...
func (m *MockDiff) GetRewardUTXOs(arg0 ids.ID) ([]*cflt.UTXO, error) {
	m.ctrl.T.Helper()
...
func (m *MockDiff) GetUTXO(arg0 ids.ID) (*cflt.UTXO, error) {
	m.ctrl.T.Helper()
