...
// Source: github.com/coinflect/coinflectchain/vms/platformvm/state (interfaces: State)
...
import (
	...
	database "github.com/coinflect/coinflectchain/database"
	ids "github.com/coinflect/coinflectchain/ids"
	choices "github.com/coinflect/coinflectchain/snow/choices"
	validators "github.com/coinflect/coinflectchain/snow/validators"
	cflt "github.com/coinflect/coinflectchain/vms/components/cflt"
	blocks "github.com/coinflect/coinflectchain/vms/platformvm/blocks"
	status "github.com/coinflect/coinflectchain/vms/platformvm/status"
	txs "github.com/coinflect/coinflectchain/vms/platformvm/txs"
...
func (m *MockState) AddRewardUTXO(arg0 ids.ID, arg1 *cflt.UTXO) {
	m.ctrl.T.Helper()
...
func (m *MockState) AddUTXO(arg0 *cflt.UTXO) {
	m.ctrl.T.Helper()
...
func (m *MockState) GetRewardUTXOs(arg0 ids.ID) ([]*cflt.UTXO, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRewardUTXOs", arg0)
	ret0, _ := ret[0].([]*cflt.UTXO)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockState) GetUTXO(arg0 ids.ID) (*cflt.UTXO, error) {
	m.ctrl.T.Helper()
