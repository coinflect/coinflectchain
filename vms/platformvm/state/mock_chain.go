...
// Source: github.com/coinflect/coinflectchain/vms/platformvm/state (interfaces: Chain)
...
func (m *MockChain) AddRewardUTXO(arg0 ids.ID, arg1 *cflt.UTXO) {
	m.ctrl.T.Helper()
...
func (m *MockChain) AddUTXO(arg0 *cflt.UTXO) {
	m.ctrl.T.Helper()
...
func (m *MockChain) GetRewardUTXOs(arg0 ids.ID) ([]*cflt.UTXO, error) {
	m.ctrl.T.Helper()
...
func (m *MockChain) GetUTXO(arg0 ids.ID) (*cflt.UTXO, error) {
	m.ctrl.T.Helper()
