...
import (
	...
	"github.com/coinflect/coinflectchain/snow/validators/gvalidators"
	...
	aliasreaderpb "github.com/coinflect/coinflectchain/proto/pb/aliasreader"
	appsenderpb "github.com/coinflect/coinflectchain/proto/pb/appsender"
	httppb "github.com/coinflect/coinflectchain/proto/pb/http"
	keystorepb "github.com/coinflect/coinflectchain/proto/pb/keystore"
	messengerpb "github.com/coinflect/coinflectchain/proto/pb/messenger"
	rpcdbpb "github.com/coinflect/coinflectchain/proto/pb/rpcdb"
	sharedmemorypb "github.com/coinflect/coinflectchain/proto/pb/sharedmemory"
	subnetlookuppb "github.com/coinflect/coinflectchain/proto/pb/subnetlookup"
	validatorstatepb "github.com/coinflect/coinflectchain/proto/pb/validatorstate"
	vmpb "github.com/coinflect/coinflectchain/proto/pb/vm"
)
...
func (vm *VMServer) Initialize(ctx context.Context, req *vmpb.InitializeRequest) (*vmpb.InitializeResponse, error) {
	...
	cfltAssetID, err := ids.ToID(req.CfltAssetId)
	if err != nil {
		return nil, err
	}
