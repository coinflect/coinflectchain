...
func TestIndexTransaction_MultipleAddresses(t *testing.T) {
	...
	var inputUTXOs []*cflt.UTXO //nolint:prealloc
...
func buildPlatformUTXO(utxoID cflt.UTXOID, txAssetID cflt.Asset, addr ids.ShortID) *cflt.UTXO {
	return &cflt.UTXO{
		UTXOID: utxoID,
		Asset:  txAssetID,
...
func buildTX(utxoID cflt.UTXOID, txAssetID cflt.Asset, address ...ids.ShortID) *txs.Tx {
