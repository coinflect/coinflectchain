...
import (
	...
	"github.com/coinflect/coinflectchain/network"
	"github.com/coinflect/coinflectchain/snow"
	"github.com/coinflect/coinflectchain/snow/consensus/snowball"
	"github.com/coinflect/coinflectchain/snow/engine/coinflect/state"
	...
	"github.com/coinflect/coinflectchain/snow/engine/common/tracker"
	"github.com/coinflect/coinflectchain/snow/engine/snowman/block"
	"github.com/coinflect/coinflectchain/snow/engine/snowman/syncer"
	"github.com/coinflect/coinflectchain/snow/networking/handler"
	"github.com/coinflect/coinflectchain/snow/networking/router"
	"github.com/coinflect/coinflectchain/snow/networking/sender"
	"github.com/coinflect/coinflectchain/snow/networking/timeout"
	"github.com/coinflect/coinflectchain/snow/validators"
	"github.com/coinflect/coinflectchain/trace"
	"github.com/coinflect/coinflectchain/utils/buffer"
	...
	"github.com/coinflect/coinflectchain/vms/metervm"
	"github.com/coinflect/coinflectchain/vms/proposervm"
	"github.com/coinflect/coinflectchain/vms/tracedvm"

	dbManager "github.com/coinflect/coinflectchain/database/manager"
	timetracker "github.com/coinflect/coinflectchain/snow/networking/tracker"

	avcon "github.com/coinflect/coinflectchain/snow/consensus/coinflect"
	aveng "github.com/coinflect/coinflectchain/snow/engine/coinflect"
	avbootstrap "github.com/coinflect/coinflectchain/snow/engine/coinflect/bootstrap"
	avagetter "github.com/coinflect/coinflectchain/snow/engine/coinflect/getter"

	smcon "github.com/coinflect/coinflectchain/snow/consensus/snowman"
	smeng "github.com/coinflect/coinflectchain/snow/engine/snowman"
	smbootstrap "github.com/coinflect/coinflectchain/snow/engine/snowman/bootstrap"
	snowgetter "github.com/coinflect/coinflectchain/snow/engine/snowman/getter"
)
...
var (
	...
	errUnknownVMType    = errors.New("the vm should have type coinflect.DAGVM or snowman.ChainVM")
...
func (m *manager) buildChain(chainParams ChainParameters, sb Subnet) (*chain, error) {
	...
	switch vm := vm.(type) {
	case vertex.DAGVM:
		chain, err = m.createCoinflectChain(
			ctx,
		...
		if err != nil {
			return nil, fmt.Errorf("error while creating new coinflect vm %w", err)
		}
	case block.ChainVM:
...
// Create a DAG-based blockchain that uses Coinflect
func (m *manager) createCoinflectChain(
	ctx *snow.ConsensusContext,
	genesisData []byte,
	vdrs,
	beacons validators.Set,
	...
	if err != nil {
		return nil, fmt.Errorf("couldn't initialize coinflect base message handler: %w", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("error initializing coinflect bootstrapper: %w", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("error initializing coinflect engine: %w", err)
	}
